...
const  fetchRelatedVideo=()=>{
  ...
  return (
    <div className=" flex justify-center flex-row h-[cal(100%-56px)] mt-16">
      <div className="w-full max-w-[1580px] flex flex-col lg:flex-row">
        <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[100%-400px] px-4 py-3 lg:py-6 ">
          <div className="h-[200px] md:h-[700px] ml-[-16px] mr-[-16] lg:ml-0  lg:mr-0">
            <ReactPlayer
          ...
          <div className="flex  justify-between flex-col md:flex-row mt-4">
            <div className="flex">
              <div className="flex items-start">
                <div className="flex h-11 w-11 rounded-full overflow-hideen">
                  <img
      ...
      <div className="flex flex-col px-4 py-6 h-[cal(100vh-4.625rem)] overflow-y-scroll overflow-x-hidden lg:w-[250px] xl:w-[400px]">
